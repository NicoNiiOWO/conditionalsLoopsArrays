...
// console.log the "roster" array
roster.splice(roster.indexOf(process.argv[3]), 1);
console.log(roster);
//////////////////
// CONDITIONALS //
//////////////////
...
for(i = 0; i < roster.length; i++){
    console.log(roster[i].charAt(0));
    console.log(roster[i].charAt(roster[i].length-1));
}
// ==================================================================
...
var totalLength = 0;
for(i = 0; i < roster.length; i++){
    totalLength += roster[i].length;
}
console.log(totalLength / roster.length);
